  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // 성공한 API 결과들만 처리
        const [tosSummaryResult, tosFieldResult, tosHistoryResult, tosStatusResult, apiQualityResult] = results; //, latestResults] = results;
        ...
        // } else {
        //   console.warn('API 품질 데이터 로드 실패:', apiQualityResult.reason);
        //   setApiQualityData([]);
        // }
